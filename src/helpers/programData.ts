const programData = [
  {
    ...
    supportImg: [
      ...
      "/programs/hyrox/hyrox-2.png",
      "/programs/hyrox/hyrox-3.png",
    ],
    description: [
      {
      ...
      },
      {
        ...
        details: `<p><span style="color: #FFDE59">&#10004;</span> 12-WEEK PLAN - Best for beginners or those looking to build a strong endurance base and gradually peak for race day.</p><br/>
        <p><span style="color: #FFDE59">&#10004;</span> 8-WEEK PLAN - A condensed version for athletes with an existing fitness base, designed to refine, sharpen, and peak before Hyrox.</p><br/>
        <p><span style="color: #FFDE59">&#10004;</span> INSTANT ACCESS - START TRAINING TODAY!</p><br/>
        `,
      },
      {
  ...
  },
  {
    ...
    supportImg: [
      ...
      "/programs/strentgth/strength-2.png",
    ],
    description: [
      {
        heading: `PROGRAM STRUCTURE`,
        details: `<p><span style="color: #FFDE59">&#10004;</span> 2 x 6-Week Phases (12 weeks total)</p><br/>
        <p><span style="color: #FFDE59">&#10004;</span> 5 Training Days Per Week (Strength & Conditioning)</p><br/>
        <p><span style="color: #FFDE59">&#10004;</span> Progressive Overload & Performance-Based Workouts</p><br/>
        `,
      },
      {
      ...
      {
        heading: `READY TO BUILD MUSCLE, STRENGTH & ATHLETICISM?`,
  ...
  },
  {
    ...
    supportImg: [
      ...
      "/programs/calisthenics/calisthenic-2.png",
    ],
    description: [
      {
        heading: `PROGRAM STRUCTURE`,
        details: `<p style="font-weight: 700;"><span style="color: #FFDE59">&#10004;</span> 12-Week Progressive Training Plan</p><br/>
        <p style="font-weight: 700;"><span style="color: #FFDE59">&#10004;</span> 4-5 Sessions Per Week (Strength, Skill & Mobility)</p><br/>
        <p style="font-weight: 700;"><span style="color: #FFDE59">&#10004;</span> Perfect for Beginners & Intermediate Athletes</p><br/>`,
      },
      {
      ...
      {
        heading: `READY TO MASTER BODYWEIGHT TRAINING?`,
        details: `<p style="font-weight: 600; font-size: 20px;">Get Instant Access & Start Training Today!</p>`,
      },
    ],
  ...
  },
  {
    ...
    supportImg: [
      ...
      "/programs/endurance/endurance-2.png",
    ],
    description: [
      {
        heading: `CHOOSE YOUR PROGRAM`,
      ...
      {
        heading: `READY TO RUN YOUR BEST RACE?`,
        details: `<p style="font-weight: 600; font-size: 20px;">Get Instant Access & Start Training Today!</p>`,
      },
    ],
  ...
  },
  {
    ...
    supportImg: [
      ...
      "/programs/functional/functional-program-2.png",
    ],
    description: [
      {
        heading: `WHAT YOU GET?`,
        details: `<p><span style="color: #FFDE59">&#10004;</span> 4-5 Structured Workouts Per Week - Focused on strength, explosiveness, and endurance.</p><br/>
  ...
  },
  {
    ...
    supportImg: [
      ...
      "/programs/wod-a-day/wod-a-day-2.png",
    ],
    description: [
      {
        heading: `WHAT YOU GET?`,
      ...
      {
        heading: `JOIN HYBRID LAB & GET STARTED TODAY!`,
        details: `<p style="font-weight: 600; font-size: 20px;">Get Instant Access & Start Training Today!</p>`,
      },
    ],
...
export { programData as All_Program_Details };
