    ...
    >
      <div className="flex flex-col items-center gap-4 lg:gap-7">
        ...
        <p className="text-base text-center text-white/80 lg:tracking-[0.04em] lg:text-2xl">
          ...
          through a dynamic blend of strength and endurance training. Our online
          programs are designed to cater to athletes and fitness enthusiasts at
          all levels, whether you&apos;re working out at home or in a gym.
        </p>
      </div>
